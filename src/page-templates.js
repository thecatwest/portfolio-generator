...
const generateAbout = (aboutText) => {
  ...
  return `
    <section class="my-3" id="about">
        <h2 class="text-dark br-primary p-s display-inline-block">About Me</h2>
        <p>${aboutText}</p>
    </section>
    `;
};
    ...
    <section class="my-3" "id="portfolio">
        ...
        ${projectsArr
            ...
            <div class="col-12 col-md-6 md-2 bg-dark text-light p-3 flex-column">
                ...
                <p>${description}</p>
                <a href="${link} class="btn mt-auto"><i class="fab fa-github mr-2">View Project on GitHub</i>
            </div>
            `; 
            })
            .join('')}
...
//   return `
//     <section class="my-3" id="portfolio">
//         <h2 class="text-dark bg-primary p-s display-inline-block">Work</h2>
//         <div class="flex-row justify-space-between">
            ...
            <div class="container flex-row justify-space-between align-center py-3">
                <h1 class="page-title text-secondary bg-dark py-2 px-3">${
                  header.name
                    ...
                    <nav class="flex-row">
                        <a class="ml-2 px-2 py-1 by-secondary text-dark" href="https://github.com/${
                          header.github
                        }">GitHub</a>
                    </nav>
            </div>
